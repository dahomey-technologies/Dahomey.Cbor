    ...
    internal static class CddlEmitter
    {
            ...
            SourceProductionContext spc)
        {
            ...
            foreach (TypeModel model in InEmissionOrder(ordered, roots))
            {
                ...
                if (model.Kind != TypeKind.Object)
                {
                    ...
                    {
                        EmitRootAliasRule(builder, model, key, byKey, ruleNames, referenceNames, options, spc);
                    }
            ...
            SourceProductionContext spc)
        {
            ...
            if (rendered is null)
            {
                ...
                // silent hole CBOR1007 exists to prevent. The root stands in for the member slot, since
